...
<div id="container">
	...
	<div id="header-top">
		<p>
			 <?php echo ($siteWelcome); ?> <a style="float:right;color:#e2a4c1;text-decoration:underline; margin-right:10px;" onclick="$.get('/index.php/Home/Homepage/switchLang',{},function(res){if(res) window.location.reload();},'json');"><?php echo ($lang); ?></a>
		</p>
	</div>
